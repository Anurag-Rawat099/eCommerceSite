    ...
    <div className='flex items-center py-5 justify-between font-medium'>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute right-[-12] pt-4">
        ...
        <Link to='/cart' className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] bg-black text-white rounded-full aspect-square w-4 text-center text-[8px] leading-4 ">6</p>
        </Link>
